      ...
      <div className="flex flex-col items-center">
        {isLoading ? (
          ...
          <>
            ...
            <section className="flex flex-col md:flex-row w-full mb-32">
              ...
              <div className="w-full md:w-1/2 flex flex-col items-start justify-center ">
                ...
                <p className="mb-4 font-light">
                  ...
                  ipsum sit dolor amet. Lorem ipsum sit dolor amet. Lorem ipsum
                  sit dolor amet. Lorem ipsum sit dolor amet. Lorem ipsum sit
            ...
            <div
              id="demo"
              className="pb-20 px-5 md:px-10 w-full max-w-4xl mb-20"
            >
